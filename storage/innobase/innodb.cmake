...
IF(UNIX)
  IF(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    SET(LIBAIO_DIR "${PROJECT_SOURCE_DIR}/third_party" CACHE PATH "libaio directory")

    INCLUDE_DIRECTORIES(${LIBAIO_DIR}/include)
    LINK_DIRECTORIES(${LIBAIO_DIR}/lib)

    # 指定检查时需要用的头文件和库路径
    set(CMAKE_REQUIRED_INCLUDES ${LIBAIO_DIR}/include)
    set(CMAKE_REQUIRED_LIBRARIES ${LIBAIO_DIR}/lib/libaio.a)

    CHECK_INCLUDE_FILES("libaio.h" HAVE_LIBAIO_H)
    CHECK_LIBRARY_EXISTS(aio io_queue_init "${LIBAIO_DIR}/lib" HAVE_LIBAIO)
    
    IF(HAVE_LIBAIO_H AND HAVE_LIBAIO)
      ADD_DEFINITIONS(-DLINUX_NATIVE_AIO=1)
      #LINK_LIBRARIES(aio)
      LINK_LIBRARIES(${LIBAIO_DIR}/lib/libaio.a)
    ENDIF()
